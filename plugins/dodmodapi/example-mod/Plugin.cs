...
public sealed class ExampleMod : BaseUnityPlugin {
    private void Awake() {
        ...
        DODModAPI.TextureManager.RegisterTexture(ExampleAssets.TileSpritesheetResource); // from ITEM directive
        DODModAPI.TextureManager.RegisterTexture(ExampleAssets.SpritesAtlasResource); // from SPRITE directive
        DODModAPI.TextureManager.RegisterTexture(ExampleAssets.SurfaceTopsResource); // from SURFACE directive
        DODModAPI.TextureManager.RegisterTexture(ExampleAssets.exampleSurface_surfaceMaterial); // from SURFACE directive
        DODModAPI.TextureManager.RegisterTexture(ExampleAssets.UnitsAtlasResource_100); // from UNIT directive
