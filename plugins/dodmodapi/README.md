...
- Custom textures, sprites, tiles, surfaces, and background surfaces (`SpriteManager`, `SurfaceManager`)
...
| `SpriteManager` | Registers embedded textures and custom sprite/tile references. |
...
public class MyMod : BaseUnityPlugin {
    private void Awake() {
        ...
        DODModAPI.SpriteManager.RegisterTexture(MyAssets.TileSpritesheetResource);
...
Don't forget to register the corresponding texture resource names in the `Awake()` with `DODModAPI.SpriteManager.RegisterTexture()`!
...
It demonstrates how to use `SpriteManager`, `ItemManager`, `UnitManager`, `EventManager`,
