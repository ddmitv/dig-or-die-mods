...
| `UnsavedTimeThreshold` | `float` | `5`     | Show quit confirmation when you have unsaved progress older than this duration. Set to 0 to always show it       |
...
| `ExitOnShift`          | `bool`  | `true`  | When "SAVE AND QUIT" button with Shift modifier is pressed, the game immediately exits                           |
